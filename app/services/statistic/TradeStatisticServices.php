...
{
    public array $_day = ['00时', '01时', '02时', '03时', '04时', '05时', '06时', '07时', '08时', '09时', '10时', '11时', '12时', '13时', '14时', '15时', '16时', '17时', '18时', '19时', '20时', '21时', '22时', '23时', '24时'];
    ...
    public function getTopRightOneTrade()
    {
        ...
        $todayHourOrderCount = $this->trendYdata((array)$todayHourOrderCount, $orderCountWhere['timeKey']);
        //昨日订单数
        ...
        $todayHourOrderPeople = $this->trendYdata((array)$todayHourOrderPeople, $orderPeopleWhere['timeKey']);
        //昨日支付人数
    ...
    public function getTopRightTwoTrade()
    {
        ...
        $monthCurveOrderCount = $this->trendYdata((array)$monthCurveOrderCount, $monthOrderCountWhere['timeKey']);
        //上月订单数
        ...
        $monthCurveOrderPeople = $this->trendYdata((array)$monthCurveOrderPeople, $monthOrderPeopleWhere['timeKey']);
        //上月支付人数
    ...
    public function getOrderRefundTotalMoney($where, string $selectType, string $group = '', bool $isNum = false)
    {
        ...
        if ($group) {
            $totalMoney = $this->trendYdata((array)$totalMoney, $whereOrderMoner['timeKey']);
        }
        return $totalMoney;
    }
    ...
    public function getExtractTotalMoney($where, string $selectType, string $group = "", bool $isNum = false)
    {
        ...
        if ($group) {
            ...
            $totalMoney = $this->trendYdata((array)$totalMoney, $whereData['timeKey']);
