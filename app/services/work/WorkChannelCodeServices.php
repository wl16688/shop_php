...
class WorkChannelCodeServices extends BaseServices
{
    ...
    /**
     * @var WorkChannelCodeDao
     */
    #[Inject]
    protected WorkChannelCodeDao $dao;
    ...
    public function getList(array $where)
    {
        ...
        $workClientFollowServices = app()->make(WorkClientFollowServices::class);
        foreach ($list as &$item) {
            ...
            $item["client_num"] =$workClientFollowServices->getChannelCodeClientCount($item["id"]);
        }
