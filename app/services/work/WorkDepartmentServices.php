...
class WorkDepartmentServices extends BaseServices
{
    ...
    /**
     * @var WorkDepartmentDao
     */
    #[Inject]
    protected WorkDepartmentDao $dao;
    ...
    public function getDepartmentList()
    {
        ...
        $data = $this->dao->getDataList(['corp_id' => $config->corpId], ['department_id', 'parentid', 'name', 'name_en']);
    ...
    {
        $list = $this->dao->getDataList(['corp_id' => $corpId], ['department_id', 'parentid', 'name', 'name_en'], 0, 0, 'srot', [
            'member' => fn($query) => $query->where('corp_id', $corpId)
