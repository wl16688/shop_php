...
use app\validate\admin\serve\ExpressValidate;
use app\validate\admin\serve\MealValidate;
...
class Serve extends AuthController
{
    ...
    public function payMeal()
    {
        ...
        $this->validate($data, MealValidate::class);
    ...
    public function openExpress()
    {
        ...
        $this->validate($data, ExpressValidate::class);
    ...
    public function updatePhone(SmsAdminServices $services)
    {
        ...
        $this->validate($data, ServeValidate::class, 'phone');
