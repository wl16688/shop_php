...
//            ['store_password', ''],
    ...
    public function delete($id)
    {
        ...
        if ($storeInfo->is_del == 1) {
            ...
            if ($orderCount) {
                return $this->fail('删除失败,该自提点还有待处理订单');
            }
            $storeInfo->is_del = 1;
            if (!$storeInfo->save()) {
