...
class StoreCoupon extends AuthController
{
     ...
     */
    #[Inject]
    protected StoreCouponService $services;
    ...
    {
        [$_id, $coupon_title, $rangeTime, $count, $status, $is_permanent, $full_reduction, $is_give_subscribe, $is_full_give, $is_type] = $this->request->postMore([
            'id',
            ['coupon_title', ''],
            ['range_date', ['', '']],
            ['count', 0],
