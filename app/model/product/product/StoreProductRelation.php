...
class StoreProductRelation extends Model
{
    ...
    {
        return $this->hasOne(StoreProductCategory::class, 'id', 'relation_id')->bind([
            'cate_name' => 'cate_name'
        ]);
    }
    ...
    {
        return $this->hasOne(StoreProductCategory::class, 'id', 'relation_id');
    }
	...
	*/
	...
	{
		return $this->hasOne(StoreProductSpecs::class, 'id', 'relation_id')->order('sort desc');
	}
