...
class Express extends BaseManager
{
     ...
     * @var string
     */
    protected string $namespace = '\\crmeb\\services\\express\\storage\\';
    ...
    protected function invokeClass($class)
    {
        ...
        $handleAccessToken = new AccessTokenServeService($this->config['access_key'] ?? '', $this->config['secret_key'] ?? '', app()->cache);
