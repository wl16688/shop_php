        ...
        <TimelineItem>
          ...
          <div class="content">
            <div v-for="(item, index) in list" :key="index" class="item">
              <div v-for="(txt, k) in item.text" :key="k" class="text">
                <div :key="txt" v-html="txt"></div>
              </div>
              <Alert v-if="item.alert.length" show-icon>
                <div>注意事项：</div>
                <div v-for="(alt, i) in item.alert" :key="i">
                  <div v-html="alt"></div>
                </div>
              </Alert>
              <div class="image">
                <img v-for="(img, j) in item.image" :key="j" :src="`${baseURL}/statics/system/${item.image}`" alt="" />
              </div>
            </div>
          </div>
        </TimelineItem>
