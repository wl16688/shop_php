          ...
          <div style="width: 340px; margin: 150px 100px 0 120px">
            ...
            >
              ...
              <FormItem
                label="APPID："
                prop="appid"
                v-if="customdate.status == 2"
              >
                <Input
                  v-model="customdate.appid"
                  placeholder="请输入正确APPID"
                ></Input>
              </FormItem>
              <FormItem
                label="小程序路径："
              ...
              >
                <Input
                  v-model="customdate.mpUrl"
                  placeholder="请输入正确小程序路径"
                ></Input>
              </FormItem>
            </Form>
          </div>
...
export default {
          ...
          h("Radio", {
            ...
            on: {
              "on-change": () => {
                ...
                this.currenName = params.row.info || params.row.store_name;
              },
            },
          }),
        ]);
  ...
  methods: {
    ...
    ok() {
      console.log(this.currenUrl, this.currenName, "111");
      if (this.currenUrl == "") {
