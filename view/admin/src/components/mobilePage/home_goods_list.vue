              ...
              <div class="info">
                <div class="hd">
                  ...
                  >
                    {{
                      item.store_name ||
                      "华为荣耀畅享平板换屏服务 屏幕换外屏主板维修"
                    }}
                  </div>
                  <img
                    v-if="checkboxInfo.indexOf(1) != -1"
                    src="../../assets/images/goods01.png"
                  />
                </div>
                <div
                ...
                >
                  ...
                  >
                    <span>￥</span
                    >{{ item.price ? $HandlePrice(item.price, 0) : 33
                    }}<span>{{
                      item.price ? $HandlePrice(item.price, 1) : ""
                    }}</span>
                  </div>
                  <img
                    class="img"
                    v-if="checkboxInfo.indexOf(5) != -1"
                    src="../../assets/images/goods02.png"
                  />
                </div>
                <div class="bottom">
                  <span
            ...
            >
              ...
              >
                <div class="hd">
                  ...
                  >
                    {{ item.store_name || "海南梅陇蜜瓜 2.5kg海 梅陇蜜瓜 2" }}
                  </div>
                  <img
                    v-if="checkboxInfo.indexOf(1) != -1"
                    src="../../assets/images/goods01.png"
                ...
                <div class="price acea-row row-middle">
                  ...
                  >
                    <span>￥</span
                    >{{ item.price ? $HandlePrice(item.price, 0) : 77
                    }}<span>{{
                      item.price ? $HandlePrice(item.price, 1) : ""
                    }}</span>
                  </div>
