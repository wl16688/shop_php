    ...
    <div class="home_product">
      ...
      <div class="menus" :class="styleConfig == 2 ? 'on' : ''" v-else>
        <div
          ...
          :style="{
            color:
              index == tabCur ? (toneConfig ? textColor : '#333') : '#282828',
          }"
        >
          {{ item.chiild[0].val || "标题"
          }}<span
        ...
        <div
          ...
          :style="{
            color:
              index == tabCur ? (toneConfig ? textColor3 : '#fff') : '#282828',
            background:
              index == tabCur ? (toneConfig ? decorateColor : themeColor) : '',
          }"
        >
          {{ item.chiild[0].val || "标题" }}
        </div>
        ...
        <div class="item" v-for="(item, index) in list" :key="index">
          ...
          <div class="info" :style="{ borderRadius: bgRadius2 }">
            <div class="title line1">
              {{ item.store_name || "海南梅陇蜜瓜 2.5kg海梅陇蜜瓜" }}
            </div>
            <div class="pictrue">
    ...
    setConfig(data) {
      ...
      if (data.mbConfig) {
        ...
        if (goods.tabVal == 1) {
          ...
          this.list = goods.productList.list.length
