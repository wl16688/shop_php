 ...
 * data 请求参数
 */
export function userLabelAddApi(data) {
  return request({
    url: `user/user_label/save`,
    method: "post",
    data,
  });
}
...
/**
 * @description 个人中心 --- 会员标签详情
 * data 请求参数
 */
export function userLabelInfoApi(id) {
  return request({
    url: `user/user_label/info/${id}`,
    method: "get",
  });
}
...
export function channelIdentityListApi(params) {
  return request({
...
export function channelIdentityAddApi() {
  return request({
    url: `channel/identity/create`,
    method: "get",
  });
}

export function channelIdentityEditApi(id) {
  return request({
    url: `channel/identity/${id}/edit`,
    method: "get",
  });
}

export function channelIdentityUpdateApi(id,status) {
  return request({
    url: `channel/identity/set_status/${id}/${status}`,
    method: "put",
  });
}

export function channelMerchantListApi(params) {
  return request({
    url: `channel/merchant`,
    method: "get",
    params,
  });
}

export function channelMerchantVerifyApi(id) {
  return request({
    url: `channel/merchant/verify/form/${id}`,
    method: "get",
  });
}

export function channelMerchantCreateApi(data) {
  return request({
    url: `channel/merchant`,
    method: "post",
    data
...
export function channelIdentityOptionsApi() {
  return request({
    url: `channel/identity/all`,
    method: "get",
  });
}

export function channelMerchantInfoApi(id) {
  return request({
    url: `channel/merchant/${id}`,
    method: "get",
  });
}

export function channelUserRecordApi(id, params) {
  return request({
    url: `user/order_list/${id}`,
    method: "get",
    params,
  });
}