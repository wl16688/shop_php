 ...
 * @returns
 */
export function getAgentBasic(params) {
  return request({
 ...
 * @returns
 */
export function getAgentTrend(params) {
  return request({
    url: '/agent/division/trend',
    method: 'get',
    params
  });
}
 ...
 * @returns
 */
export function divisionRanking(params) {
  return request({
    url: '/agent/division/ranking',
    method: 'get',
    params
  });
}
