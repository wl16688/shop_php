 ...
 * @description 商品详情
 */
export function productInfoDetail(id) {
  return request({
    url: `product/product/info/${id}`,
    method: 'get'
  });
}
 ...
 */
export function productUserLabel(params) {
  return request({
 ...
 * @description 商品分享二维码
 */
export function productExportCode(id) {
  return request({
    url: `product/link_and_code/${id}`,
    method: 'get',
  });
}

/**
 * @description 商品属性 -- 批量移回收站
 * @param {Object} param data {Object} 传值对象
 */
export function productRecycleApi(data) {
  return request({
    url: `product/product/product_recycle`,
    method: 'put',
    data
  });
}
...
/**
 * @description 商品属性 -- 批量删除
 * @param {Object} param data {Object} 传值对象
 */
export function productThoroughDelApi(data) {
  return request({
    url: `product/product/product_thorough_del`,
    method: 'put',
    data
  });
}
...
/**
 * @description 商品属性 -- 批量审核
 * @param {Object} param data {Object} 传值对象
 */
export function productBatchVerifyApi(data) {
  return request({
    url: `product/product/batch_verify`,
    method: 'post',
    data
  });
}