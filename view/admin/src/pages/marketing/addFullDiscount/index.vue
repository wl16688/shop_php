  ...
  <div class="form-submit">
    <div class="i-layout-page-header">
      <PageHeader class="product_tabs" hidden-breadcrumb>
        <div slot="title">
          <router-link
            :to="{ path: '/admin/marketing/discount/full_discount' }"
          >
              ...
              <div class="list">
                ...
                >
                  ...
                  >
                    ...
                    <span class="del" @click="delGrade(index)" v-if="index"
                      >删除</span
                    >
                  </div>
    ...
    getDiscountInfo() {
      discountInfo(this.$route.params.id)
        .then((res) => {
          ...
          this.formValidate.is_overlay =
            this.formValidate.is_overlay.toString();
          this.formValidate.promotions_cate =
            this.formValidate.promotions_cate.toString();
    ...
    handleSubmit: Debounce(function (name) {
      this.$refs[name].validate((valid) => {
        if (valid) {
          ...
          savePromotions(3, this.$route.params.id, this.formValidate)
            .then((res) => {
              this.$router.push({
