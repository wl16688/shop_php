          ...
          <div class="iframe-boxs">
            <div class="moneyBox">
              ...
              <div class="moneyBox_content">
                ...
                <div class="box3">
                  <div class="box3_box"  v-for="(item, index) in rechargeFilter" :key="index">
                    <div>{{ item.price }}<i class="font">元</i></div>
                    <div class="font" v-show="item.give_money != 0">
...
export default {
  ...
  computed: {
    ...
    rechargeFilter(){
      return this.recharge.filter((item) => {
  ...
  methods: {
    ...
    groupAdd() {
      this.$modalForm(
        groupDataAddApi(
          { gid: this.gid, config_name: this.name },
    ...
    edit(row) {
      this.$modalForm(
        groupDataEditApi(
          { gid: row.gid, config_name: this.name },
