        ...
        <Card :bordered="false" dis-hover class="ive-mt">
            ...
            <Table :columns="columns1" :data="tableList" :loading="loading" highlight-row
                ...
                <template slot-scope="{ row }" slot="status">
                    <Tag color="cyan" size="medium" v-show="row.status == 1">进行中</Tag>
                    <Tag color="green" size="medium" v-show="row.status == 2">已完成</Tag>
                    <Tag color="error" size="medium" v-show="row.status == 3">未完成</Tag>
                </template>
