<template>
  <div>
    <Card :bordered="false" dis-hover class="mt15 ivu-mt" :padding="0">
      <div class="header">
        <span class="title">营销玩法</span>吸粉、老客带新客，提高下单转化率
      </div>
      <div class="list acea-row row-middle">
        <div
          class="item acea-row row-middle"
          v-for="(item, index) in markePlay"
          :key="index"
          @click="tapMarke(item)"
        >
    ...
    <Card :bordered="false" dis-hover class="mt15 ivu-mt" :padding="0">
      <div class="header">
        <span class="title">营销互动</span>增强互动，留存复购
      </div>
      <div class="list acea-row row-middle">
        <div
          class="item acea-row row-middle"
          v-for="(item, index) in markeInteract"
          :key="index"
          @click="tapMarke(item)"
        >
          <div class="iconfont" :class="item.icon"></div>
