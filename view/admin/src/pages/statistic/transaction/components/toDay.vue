      ...
      <Col v-if="statisticsData" v-bind="grid" style="padding-left: 20px">
        <div class="pl25">
          <div class="toDay">
            ...
            <span class="toDay-number spBlock mb10 ml5">{{
              statisticsData.right.today.series[0].now_money
            }}</span>
            <br /><span class="toDay-time spBlock mr10"
              >昨日：{{ statisticsData.right.today.series[0].last_money }}</span
            >
            <span class="toDay-time spBlock"
              ...
              <i
                class="content-is"
                :class="
                  Number(statisticsData.right.today.series[0].rate) >= 0
                    ? 'up'
                    : 'down'
                "
            ...
            <span class="toDay-number spBlock mb10 ml5">{{
              statisticsData.right.month[0].now_money
            }}</span>
            <br /><span class="toDay-time spBlock mr10"
              >上月：{{ statisticsData.right.month[0].last_money }}</span
            >
            <span class="toDay-time spBlock"
              >月环比：
              <i
                class="content-is"
                :class="
                  Number(statisticsData.right.month[0].rate) >= 0
                    ? 'up'
                    : 'down'
                "
          ...
          <div class="toDay" style="border: none">
            ...
            <span class="toDay-number spBlock mb10 ml5">{{
              statisticsData.right.today.series[1].now_money
            }}</span>
            <br /><span class="toDay-time spBlock mr10"
              >昨日：{{ statisticsData.right.today.series[1].last_money }}</span
            >
            <span class="toDay-time spBlock"
              >日环比：
              <i
                class="content-is"
                :class="
                  Number(statisticsData.right.today.series[1].rate) >= 0
                    ? 'up'
                    : 'down'
                "
            ...
            <span class="toDay-number spBlock mb10 ml5">{{
              statisticsData.right.month[1].now_money
            }}</span>
            <br /><span class="toDay-time spBlock mr10"
              >上月：{{ statisticsData.right.month[1].last_money }}</span
            >
            <span class="toDay-time spBlock"
              >月环比：
              <i
                class="content-is"
                :class="
                  Number(statisticsData.right.month[1].rate) >= 0
                    ? 'up'
                    : 'down'
                "
