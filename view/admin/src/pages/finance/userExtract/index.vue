  ...
  <div>
    <Card :bordered="false" dis-hover class="ivu-mt" :padding="0">
      <div class="card_pd">
        ...
        >
          ...
          <FormItem>
            <Button type="primary" @click="selChange" class="btn-add"
              >查询</Button
            >
    ...
    <Card :bordered="false" dis-hover>
      ...
      >
        ...
        <template slot-scope="{ row }" slot="extract_type_name">
          ...
          <span v-if="row.extract_type === 'balance'">余额</span>
        </template>
        ...
        <template slot-scope="{ row }" slot="qrcode_url">
          <div
            v-if="
              ['weixin', 'alipay'].includes(row.extract_type) && row.qrcode_url
            "
          >
