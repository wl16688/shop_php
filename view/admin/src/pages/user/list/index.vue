          ...
          <div class="search-form">
            <div>
              ...
              <template v-if="collapse">
                ...
                <template v-if="userFrom.country === 'domestic'">
                  <FormItem label="省份：">
                    <Cascader
                      :data="addresData"
                      change-on-select
        ...
        <Col span="24">
          <div class="flex-between-center">
            <div class="flex-between-center">
              ...
              <Button class="ml-14" @click="exports()">数据导出 </Button>
            </div>
            <span class="view-record" @click="viewImportRecord"
              >查看导入记录</span
            >
          </div>
        </Col>
        ...
        <Col span="20">
          <Form :model="batchData" :label-width="122" @submit.native.prevent>
            ...
            <FormItem v-if="menuActive === 2" label="用户标签：">
              <div class="select-tag" @click="openLabelList(1)">
...
export default {
  ...
  methods: {
    ...
    openLabelList(type) {
      ...
      this.$refs.labelList.userLabel(data, type);
    },
    // 标签弹窗关闭
    labelListClose() {
      this.labelListShow = false;
    ...
    changeMenu(row, name, index) {
      ...
      switch (name) {
        case "1":
          ...
          this.$refs.userDetails.isEdit = false;
        ...
        case "7":
          ...
          break;
        case "8":
          this.getOtherFrom(row.uid, 1);
          break;
        case "9":
          this.getOtherFrom(row.uid, 2);
          break;
        case "10":
          this.$refs.userDetails.modals = true;
          this.$refs.userDetails.isEdit = true;
          this.$refs.userDetails.activeName = "info";
          this.$refs.userDetails.getDetails(row.uid);
          break;
        case "11":
...
.search-form {
  ...
  .searc-btn-box >>> .ivu-form-item-content{
    display: flex;
    flex-wrap: nowrap;
    white-space: nowrap;
