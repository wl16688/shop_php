                  ...
                  <div class="left">
                    ...
                    <span>
                      {{ item._status._title
                        ...
                        v-if="item.refund.length && item._status._type != -2"
                        >{{
                  ...
                  >
                    ...
                    <div class="info">
                      <div class="name line1">
                        <span v-if="goods.is_gift == 1" class="label"
                          >[赠品]</span
                        >
...
export default {
  ...
  methods: {
    ...
    // 订单发货
    openDelivery(item) {
      if (item.refund.length)
        return this.$Message.warning("存在售后待处理订单");
    ...
    // 订单改价
    orderEdit(id) {
      this.$refs.changePrice.id = id;
      this.$refs.changePrice.ordeUpdateInfo(id);
