    ...
    >
      <div slot="title" class="f_return acea-row row-between-wrapper">
        ...
        <div class="buttons">
          ...
          <Button ghost class="bnt w-74" @click="preview" v-if="pageId"
            ><span class="iconfont iconshouyintai-yanjing"></span>预览</Button
          >
          <Button
            ghost
            class="bnt ml20 w-74"
              ...
              >
                ...
                >
                  <div>
                    ...
                    <svg
                      class="conter iconfont-diy icon svg-icon"
                      aria-hidden="true"
                    >
          ...
          <div class="content">
            ...
            >
              ...
              <div class="defaultData" v-if="pageId !== 0">
                ...
                <button class="data" @click="saveConfig(1, 1, 1)">
                  另存模板
                </button>
...
export default {
  ...
  computed: {
    ...mapState({
      ...
      pageFooterType: (state) =>
        state.admin.mobildConfig.pageFooter.navConfig.tabVal,
      pageFooterBottom: (state) =>
        state.admin.mobildConfig.pageFooter.mbConfig.val,
  ...
  methods: {
    ...
    determine() {
      if (this.nameTxts.trim() == "") {
        return this.$Message.error("请输入模板名称");
      }
      if (this.pageId == 0) {
        this.$store.commit("admin/mobildConfig/UPNAME", this.nameTxts);
        this.$Message.success("修改成功");
        this.visible = false;
        return false;
      }
      diyUpdateName(this.pageId, { name: this.nameTxts })
        .then((res) => {
