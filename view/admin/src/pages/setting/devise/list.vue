    ...
    <Row class="ivu-mt box-wrapper acea-row">
      ...
      <Col class="right-wrapper">
        <Card :bordered="false" dis-hover v-if="cardShow == 0">
          <div class="flex" v-if="cardShow == 0">
            <div class="phone-box" v-if="isDiy">
              <iframe
                class="iframe-box"
            ...
            <div :class="isDiy ? 'tableDiv' : 'table'">
              <div class="acea-row row-between-wrapper">
                <Row type="flex">
                  <Col v-bind="grid">
                    <div class="button acea-row row-middle">
                      <Button type="primary" @click="add">添加专题页</Button>
                    </div>
                  </Col>
                </Row>
              </div>
    ...
    >
      <div class="acea-row row-center-wrapper">
        <Button
          ...
          >保存</Button
        >
        <Button class="bnt ml20" @click="reast" v-if="cardShow == 1"
          >重置</Button
        >
      </div>
    </Card>
