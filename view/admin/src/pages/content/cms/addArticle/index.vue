            ...
            <FormItem label="文章简介：" prop="synopsis" label-for="synopsis">
              <div class="flex">
                ...
                <AiModule
                  ...
                  mode="drawer"
                  trigger-text="AI润色"
                  :default-content="formValidate.synopsis"
                  :api-params="{
                    type: 'article_content',
                  }"
                  @generated="(res) => handleGenerated(res, 'synopsis')"
                  @fill="(res) => handleFill(res, 'synopsis')"
                />
              </div>
            </FormItem>
          </Col>
...
export default {
  name: "addArticle",
  components: { uploadPictures, WangEditor, AiModule },
  data() {
  ...
  methods: {
    ...
    handleGenerated(res, key) {
      this.formValidate[key] = res;
    },
    handleFill(res, key) {
      this.formValidate[key] = res;
    },
