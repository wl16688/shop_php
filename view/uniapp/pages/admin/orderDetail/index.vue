<template>
	<view>
		...
		<view class="order-details pos-order-details">
			...
			<view class="remarks acea-row row-middle" @click="modify('1')"  v-if="goname != 'looks'">
				<text class="iconfont icon-ic_notes"></text>
				<view class="line1 h-100 pl-20 fs-28 flex-y-center">{{ orderInfo.remark || '订单未备注，点击添加备注信息' }}</view>
			</view>
		  ...
		  ">
			...
			<view class="wrapper">
				...
				<!-- 采购优惠 channel_price -->
				<view class="item acea-row row-between" v-if="Number(orderInfo.channel_price) > 0">
