<template>
	...
	<view :style="colorStyle">
										...
										<view class="ml-20 flex-1 flex-col justify-between">
											...
											<view class="flex-between-center "
												...
												<view class="flex-y-center pr-24 text--w111-333">
													<view class="flex-center w-48 h-48" @click.stop='subCart(jindex,index)'>
														<text class="iconfont icon-ic_Reduce fs-24" 
															:class="{'disabled-btn': item.productInfo.min_qty && item.cart_num == item.productInfo.min_qty}"></text>
													</view>
													...
													<view class="flex-center w-48 h-48" @click.stop='addCart(jindex,index,item)'>
		...
		<activityModal :pageIndex="3"></activityModal>
	</view>
</template>
